...
<head>
    <title> Album </title>
    <link rel="stylesheet" href="artista?accion=estilos">
</head>
    ...
    <section class="form-register">
      ...
      <form action="artista" method="post">
       <center> <h4>Agregar Artista</h4></center>
        ...
        <button class="botons" type="submit" class="btn btn-sucess" name="accion" value="Registrar">Registrar Artista</button>
       </form>
      </section>
</body>
</html>